...
const login = () => {
 ...
 <div class="form">
            ...
            <input type="text" name="" id="username" placeholder="username" value="${nick?.[1]?.name}">
           
            <div class="input-password">
            <input type="password" name="" id="password" placeholder="password" value="${nick?.[1]?.password}" >  
            <div>
